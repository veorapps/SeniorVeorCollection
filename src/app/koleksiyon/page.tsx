...
export default async function CollectionPage({ searchParams }: { searchParams: Promise<{ family?: string | string[]; sort?: string | string[] }> }) {
  ...
  return <CatalogListingPage activeFamily={family} data={data} mode="collection" products={products} sort={sort} />;
}
